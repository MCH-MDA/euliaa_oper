...
FILENAME_CONF=ewc_s3bucket.conf  # name of the config file. Will locate this filename in same directory as this script
...
if [ ! -f "$file_conf" ]; then
    ...
    echo "    1. copy ewc_s3bucket_example.conf to ewc_s3bucket.conf"
